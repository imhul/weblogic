...
const translations = {
    ...
    'russian': {
        ...
        'step_2021': 'Немного поработал с Getsby и GraphQL. Но позже присоединился к развивающемуся сообществу Svelte и это потрясающе! Это одна из лучших технологий, с которой мне приходилось сталкиваться. Благодаря этому стал лучше понимать SSR.',
